...
import {{IdentityEntityNamePascalCase}}Service from './{{IdentityEntityNamePascalCase}}Service';
...
class AuthenticationService {
    ...
    public generateToken(email: string, password: string): Promise<string> {
        return new Promise<string>((resolve, reject) => {
            ...
            {{IdentityEntityNamePascalCase}}Service.getByEmail(email).then((identity: any) => {
                if (!identity) return reject('{{IdentityEntityNamePascalCase}} not found.');
    ...
    public refreshToken(refreshToken: string): Promise<string> {
        return new Promise<string>((resolve, reject) => {
            ...
            {{IdentityEntityNamePascalCase}}Service.getByRefreshToken(refreshToken).then((identity: any) => {
                if (!identity) return reject('{{IdentityEntityNamePascalCase}} not found.');
